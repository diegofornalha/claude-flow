 ...
 * 
 * Usage:
 *   node a2a-chaining-demo.mjs --pattern=sequential
 *   node a2a-chaining-demo.mjs --pattern=parallel  
 *   node a2a-chaining-demo.mjs --pattern=conditional
 *   node a2a-chaining-demo.mjs --pattern=queen-orchestrated
 */
